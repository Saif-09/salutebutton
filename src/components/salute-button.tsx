  ...
  return (
    <div className={cn("relative flex items-center justify-center", className)}>
      ...
      <motion.button
        ...
        onClick={handleClick}
        className={cn(
          "relative flex select-none items-center gap-1 rounded-xl border-3 border-black bg-emerald-400 px-3 py-1.5 font-black transition-all sm:gap-1.5 sm:px-4 sm:py-2",
          pressed
