      ...
      <motion.button
        ...
        className={cn(
          lg
            ...
            : "relative flex max-w-full select-none items-center justify-center gap-1.5 overflow-hidden rounded-xl border-3 border-black bg-primary px-3 py-1 font-black text-white transition-all sm:gap-2 sm:px-5 sm:py-2",
          pressed
